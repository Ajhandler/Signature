    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
        ...
        <span class="sr-only">Next</span>c
      </a>
    </div><!-- /.carousel -->
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <i style="color:#2E8ECE;"class="fa fa-home fa-5x"></i>
          <h2>Residential</h2>
          <p>Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna.</p>
          <p><a class="btn btn-default" href="gallery.html" role="button">View work &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
         <i style="color:#E86257;"class="fa fa-building fa-5x"></i>
          <h2>Commercial</h2>
          <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh.</p>
          <p><a class="btn btn-default" href="gallery.html" role="button">View work &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
         <i style="color:#36C26E;" class="fa fa-truck fa-5x"></i>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Construction<span class="text-muted"><br>30 years experience</span></h2>
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7">
          <h2 class="featurette-heading">Design<span class="text-muted"><br>Quote about design</span></h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Development<span class="text-muted"><br>Words about development</span></h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive" data-src="holder.js/500x500/auto" alt="Generic placeholder image">
